...
import 'indicator-theme.dart';
import 'time-line-node.dart';
import 'time-line-theme.dart';
...
class TimelineTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final nodeFlex =
        _getEffectiveNodePosition(context) * timeLineFlexMultiplier;
    ...
    var items = [
      ...
      if (nodeFlex < timeLineFlexMultiplier)
        Expanded(
          flex: (timeLineFlexMultiplier - nodeFlex).toInt(),
          child: Align(
            alignment: direction == Axis.vertical
